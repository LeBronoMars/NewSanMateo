...
public class TimeUtils {
    ...
    public static final String HOUR_MINUTE_FORMAT = "HH:mm:ss";
    ...
    public static String toHoursMinutes(double duration) {
        if (minutesFrom(duration).equals("00")) {
     ...
     */
    public static String toMonthYear(long dateTime) {
     ...
     */
    public static String toYearMonthDay(long dateTime) {
    ...
    public static long appendDefaultHoursMinuteSecondsMilliseconds(long dateTime) {
        GregorianCalendar gregorianCalendar = new GregorianCalendar();
        gregorianCalendar.setTimeInMillis(dateTime);
    ...
    public static long lastTimestampOfDate(long dateTime) {
        GregorianCalendar gregorianCalendar = new GregorianCalendar();
        gregorianCalendar.setTimeInMillis(dateTime);
        gregorianCalendar.set(HOUR_OF_DAY, 23);
        gregorianCalendar.set(MINUTE, 59);
    ...
    public static double toDuration(String hours, String minutes) {
        double duration = Double.parseDouble(hours);
        double minutesNumber = Double.parseDouble(minutes);
