...
public class DtoToIncidentMapper implements ObservableTransformer<IncidentDto, Incident> {

    @Override
    public ObservableSource<Incident> apply(Observable<IncidentDto> upstream) {
        return upstream.flatMap(dto -> {
            ...
            return Observable.just(incident);
        });
    }
}
